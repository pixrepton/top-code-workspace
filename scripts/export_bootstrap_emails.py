...
_GMAIL_AUDIT_DIR = Path(__file__).resolve().parents[1] / "gmail-agent" / "tools" / "gmail_audit"
if str(_GMAIL_AUDIT_DIR) not in sys.path:
    sys.path.insert(0, str(_GMAIL_AUDIT_DIR))
