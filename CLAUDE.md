...
This file exists for Claude Code discovery. If your client supports project imports, prefer loading `AGENTS.md` directly. To regenerate this pointer from the canonical file:
